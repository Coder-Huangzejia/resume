...
interface JobDrawerProps {
    ...
    onChange:(_:JobDataItemType,allValues:JobDataType)=>void
}
        ...
        return (
            <>
                <Drawer
                    ...
                    onClose={onClose}
                >
                    <Form autoComplete="off" initialValues={{job:initialValues}} onValuesChange={onChange}>
                        <Form.List name="job" >
                            {(fields, { add, remove }) => (
                                <>
                                    {fields.map(({ key, name, ...restField }) => (
                                        <div key={key} style={{position:'relative',borderBottom:'1px solid #f0f0f0',marginBottom:'12px'}} >
                                            <Form.Item
                                                {...restField}
                                            ...
                                            >
                                                <Input placeholder="公司名称要写全名" style={{ width: '288px' }} />
                                            </Form.Item>
                                            <Form.Item
                                                {...restField}
                                                name={[name, 'period']}
                                            ...
                                            >
                                                <Input.TextArea placeholder="工作描述"  />
                                            </Form.Item>
