...
interface TechDrawerProps{
    ...
    visible:boolean;
    onChooseList:(type:'tools'|'webgl'|'frame'|'list',index:number)=>void
}
const TechDrawer:FC<TechDrawerProps> =memo(({techData,visible,setVisible,onChooseList})=>{
...
const onClose=useCallback(()=>{
  ...
  >
    <div className="chooseList">
        {tools.map((v,i)=> <div className="btn">
        <Button
      ...
      {webgl.map((v,i)=> <div className="btn">
        <Button
        type={v.select ? 'primary' : 'default'}
      ...
      {frame.map((v,i)=> <div className="btn">
        <Button
        type={v.select ? 'primary' : 'default'}
       ...
       {list.map((v,i)=> <div className="btn">
        <Button
        type={v.select ? 'primary' : 'default'}
